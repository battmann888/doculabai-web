...
function ToastItem({ toast, onDismiss }: ToastProps) {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-lg border shadow-lg backdrop-blur-sm text-white transition-all duration-300 transform ${colors[toast.type]} ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}
    >
